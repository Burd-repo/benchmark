...
pub(crate) fn build_registration_payload_from(
    ...
    let mut capabilities = serde_json::json!({
        ...
        "ai_performance_status": provider.ai_performance.status.clone(),
        "ai_performance_level": provider.ai_performance.level.clone(),
        "ai_performance_source": provider.ai_performance.source.clone(),
        "tokens_per_second": provider.ai_performance.tokens_per_second,
